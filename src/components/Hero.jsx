...
const Hero = () => {
    ...
    return (
        <section id="inicio" className="container" style={{
            marginTop: '100px', // Restored space for navbar
            marginBottom: '4rem'
        }}>
            <div style={{
                height: '55vh', // Decreased height
                minHeight: '400px',
                position: 'relative',
                display: 'flex',
                alignItems: 'center',
                overflow: 'hidden',
                backgroundColor: '#000',
                borderRadius: '30px', // Restored rounded corners
                boxShadow: '0 20px 40px rgba(0,0,0,0.15)', // Restored floating shadow
                ...
                <div style={{
                    ...
                    zIndex: 2,
                    width: '100%',
                    padding: '0 clamp(1.5rem, 5vw, 4rem)' // Fluid internal padding
                }}>
                    <div style={{ maxWidth: '800px' }}>
                        ...
                        <p style={{
                            fontSize: 'clamp(1rem, 2vw, 1.25rem)', // Fluid paragraph
